...
async def do_pm_permit_action(event, chat):  
    ...
    if custompmpermit is not None:
        ...
        USER_BOT_NO_WARN = f"(ــــــــــــــــــــــــــــ.SuoRcE SelVa-AraB.ــــــــــــــــــــــــــــ)\n\n❞اهلا بك يحوب {mention} ❝ 🦋\nلا ترسل اي رساله حاليا لان صاحب الحساب مشغول يجب عليك الانتظار او مراسلته في وقتا اخر  .. ❞ \n ⤶ ❨  `{warns}/{totalwarns}` ❩\n\n(ــــــــــــــــــــــــــــ.SuoRcE SelVa-AraB.ــــــــــــــــــــــــــــ)"
    else:
        USER_BOT_NO_WARN = f"(ــــــــــــــــــــــــــــ.SuoRcE SelVa-AraB.ــــــــــــــــــــــــــــ)\n\n❞اهلا بك يحوب {mention} ❝ 🦋\nا ترسل اي رساله حاليا لان صاحب الحساب مشغول يجب عليك الانتظار او مراسلته في وقتا اخر ❞ \n ⤶ ❨  `{warns}/{totalwarns}` ❩\n\n(ــــــــــــــــــــــــــــ.SuoRcE SelVa-AraB.ــــــــــــــــــــــــــــ)"
